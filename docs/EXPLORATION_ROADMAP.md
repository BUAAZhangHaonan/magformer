...
- **2026-09-06 口径复核**：同款 rank-strided seed-42 subset-1000 采样重评 = **0.7491**（vs 全量 0.7565，一致）——4028 训练期记录的 85-86 **无法在 32254 val 以任何采样复现**，其评测协议随 4028 下线不可考；c0 家族在 32254 全量的真实高水位是 E21 精炼线的 0.806→0.8284
