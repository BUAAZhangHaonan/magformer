...
- [VC-SUDA Stage C R31 target_labeled +25 gate, 2026-05-16](vc_suda_stage_c_r31_target_labeled_plus25_plan_20260516.md): prepared a single-variable 1024 Stage C gate that promotes 25 deterministic target_unlabeled images into target_labeled. The new splits are `50/3638` labeled and `175/9809` unlabeled; selected buckets are `15` from 90-100 instances, `8` from 31-60, and `2` from 25-30. R31 keeps the 32K source branch, LR/loss/threshold/augmentation, and R12 `ckpt499` warm start unchanged, with a 250-iteration first gate and no training launched.
