...
- [VC-SUDA Stage C R11 mask-loss continuation plan, 2026-05-15](vc_suda_stage_c_r11_mask_loss_plan_20260515.md): continue from R8B `ckpt999` with the single variable `mask_weight/dice_weight 5.0 -> 7.5`, keep `checkpoint_max_keep: null`, and select by external 1024 backmap target_unlabeled200 segm AP.
