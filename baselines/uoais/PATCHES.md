...
This directory vendors UOAIS/AdelaiDet baseline code under `baselines/uoais/`.
...
- File: `baselines/uoais/adet/__init__.py`
...
- Why:
  - `adet.modeling` imports custom ops (`adet._C`) that are only available after
    `pip install -e baselines/uoais` builds them.
...
- File: `baselines/uoais/adet/data/__init__.py`
...
- File: `baselines/uoais/adet/data/augmentation.py`
...
- File: `baselines/uoais/adet/data/dataset_mapper.py`
...
- File: `baselines/uoais/adet/data/detection_utils.py`
- Changes:
