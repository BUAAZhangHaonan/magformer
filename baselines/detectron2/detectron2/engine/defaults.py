...
def _ddp_kwargs_from_cfg(cfg):
    kwargs = {"broadcast_buffers": False}
    ddp_cfg = getattr(cfg, "DDP", None)
    if ddp_cfg is not None and hasattr(ddp_cfg, "FIND_UNUSED_PARAMETERS"):
        kwargs["find_unused_parameters"] = bool(ddp_cfg.FIND_UNUSED_PARAMETERS)
    return kwargs
...
class DefaultTrainer(TrainerBase):
    ...
    def __init__(self, cfg):
        ...
        model = create_ddp_model(model, **_ddp_kwargs_from_cfg(cfg))
