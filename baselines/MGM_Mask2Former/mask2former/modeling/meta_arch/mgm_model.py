...
from .depth_path import forward_fused_features
...
class MGMMaskFormer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        depth_backbone_enabled: bool = True,
        mgm_enabled: bool = True,
    ):
        super().__init__()
        ...
        self.depth_backbone_enabled = bool(depth_backbone_enabled)
        self.mgm_enabled = bool(mgm_enabled)
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            "depth_backbone_enabled": bool(getattr(cfg.MODEL.DEPTH_BACKBONE, "ENABLED", True)),
            "mgm_enabled": bool(getattr(cfg.MODEL.MGM, "ENABLED", True)),
        }
    ...
    def forward(self, batched_inputs):
        ...
        images = [(x.float() - self.pixel_mean) /
        ...
        use_depth_path = bool(self.depth_backbone_enabled) and bool(self.mgm_enabled)
        fused_features, confidence_maps, mgm_losses = forward_fused_features(
            rgb_backbone=self.rgb_backbone,
            depth_backbone=self.depth_backbone,
            mgm=self.mgm,
            images_tensor=images.tensor,
            depths_tensor=depths.tensor,
            depth_raw=depth_raw,
            rgb_image=images.tensor,
            depth_noise_mask=depth_noise_mask,
            use_depth_path=use_depth_path,
        )
