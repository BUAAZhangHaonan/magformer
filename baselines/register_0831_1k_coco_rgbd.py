#!/usr/bin/env python3
"""
Detectron2 COCO registration for magformer_datasets/0831_1K (RGBD).
...
DATASET_NAME_TRAIN = "ecc0831_1k_rgbd_train"
DATASET_NAME_VAL = "ecc0831_1k_rgbd_val"


def _default_dataset_root() -> Path:
    # File: <workspace>/magformer/baselines/register_0831_1k_coco_rgbd.py
    # Dataset: <workspace>/magformer_datasets/0831_1K
    workspace_root = Path(__file__).resolve().parents[2]
    return workspace_root / "magformer_datasets" / "0831_1K"


def register_0831_1k_coco_rgbd(dataset_root: Optional[str] = None) -> List[str]:
    """
    Register COCO instance datasets for 0831_1K (train/val) with RGBD file paths.
