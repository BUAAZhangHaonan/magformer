...
This directory vendors MSMFormer baseline code under `baselines/msmformer/`.
...
- File: `baselines/msmformer/MSMFormer/meanshiftformer/__init__.py`
...
- File: `baselines/msmformer/lib/fcn/get_network_crop.py`
- Changes:
