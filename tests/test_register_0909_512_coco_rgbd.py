...
def test_register_0909_512_coco_rgbd_has_depth_file_name() -> None:
    # Workspace layout:
    #   <ws>/magformer/tests/...
    ...
    register_0909_512_coco_rgbd(str(dataset_root))
    ...
    for name in [DATASET_NAME_TRAIN, DATASET_NAME_VAL]:
        ...
        for d in ds[:5]:
            ...
            assert Path(d["depth_file_name"]).suffix.lower() == ".npy"
