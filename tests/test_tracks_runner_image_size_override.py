...
@pytest.mark.parametrize(
    ...
    [
        ("run_0831_1k_20ep_scratch_maskrcnn.sh", "INPUT.MIN_SIZE_TRAIN '(1024,)'"),
        ("run_0831_1k_20ep_scratch_yolov8_seg.sh", "imgsz=1024"),
        ("run_0831_1k_20ep_scratch_ucn.sh", "--img-size 1024"),
    ],
)
def test_tracks_runner_supports_image_size_override(
    tmp_path: Path,
    script_name: str,
