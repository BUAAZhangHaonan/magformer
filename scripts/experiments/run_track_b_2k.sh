...
OUTPUT_ROOT_DEFAULT="${REPO_ROOT}/output/experiments/track_b_2k"
...
MAGFORMER_CONFIG="${MAGFORMER_DIR}/configs/magformer_track_b_2k.yaml"
...
SUMMARY_FILE="${OUTPUT_ROOT}/track_b_2k_summary.json"
...
echo "[track-b-2k] mode=${MODE}"
echo "[track-b-2k] dataset_root=${DATASET_ROOT}"
echo "[track-b-2k] output_root=${OUTPUT_ROOT}"
...
print(f'[track-b-2k] summary saved to {summary_file}')
PY"

echo "[track-b-2k] done"
