...
echo "[maskrcnn-0831-1k-5k] mode=${MODE}"
echo "[maskrcnn-0831-1k-5k] dataset_root=${DATASET_ROOT}"
echo "[maskrcnn-0831-1k-5k] output_dir=${OUT}"
echo "[maskrcnn-0831-1k-5k] config=${D2_ROOT}/${CFG_REL}"
