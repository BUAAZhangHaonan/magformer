...
OUT="${OUTPUT_ROOT}/official_mask2former"
...
echo "[official-mask2former-0831-1k-5k] mode=${MODE}"
echo "[official-mask2former-0831-1k-5k] dataset_root=${DATASET_ROOT}"
echo "[official-mask2former-0831-1k-5k] output_dir=${OUT}"
echo "[official-mask2former-0831-1k-5k] config=${MASK2FORMER_ROOT}/${CFG_REL}"
...
echo "[official-mask2former-0831-1k-5k] done"
