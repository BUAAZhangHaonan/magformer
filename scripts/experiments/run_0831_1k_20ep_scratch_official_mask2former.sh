...
runner_log "${MODE}" "${RUN_LOG}" "[official-mask2former-0831-1k-20ep-scratch] smoke=${SMOKE}"
...
run_train_cmd() {
  ...
  local cmd="cd '${REPO_ROOT}' && conda run -n magformer python baselines/run_official_mask2former_0831_1k.py \
    --dataset-root '${DATASET_ROOT}' \
